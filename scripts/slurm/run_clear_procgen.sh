...
CONFIG_ABS="/home/xjsong/ECE567_RL_Project4/continual_rl/configs/procgen/clear_procgen.json"
OUT_DIR="./srun_log/${SLURM_JOB_NAME:-clear-procgen}_${SLURM_JOB_ID:-local}"
