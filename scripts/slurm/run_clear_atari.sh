...
CONFIG_ABS="/home/xjsong/ECE567_RL_Project4/continual_rl/configs/atari/clear_atari_small_buffer.json"
OUT_DIR="./srun_log/${SLURM_JOB_NAME:-clear-atari}_${SLURM_JOB_ID:-local}"
