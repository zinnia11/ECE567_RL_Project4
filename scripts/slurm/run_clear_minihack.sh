...
#SBATCH --job-name=clear-minihack
...
LARGE_ROOT="${LARGE_ROOT:-/scratch/mcity_project_owned_root/mcity_project_owned1/xjsong/cora}"
CONFIG_ABS="${CONFIG_ABS:-/home/xjsong/ECE567_RL_Project4/continual_rl/configs/minihack/clear_minihack_small_buffer.json}"
OUT_DIR="./srun_log/${SLURM_JOB_NAME:-clear-minihack}_${SLURM_JOB_ID:-local}"
...
RUN_JSON="$(mktemp /tmp/clear_run_XXXXXX.json)"
